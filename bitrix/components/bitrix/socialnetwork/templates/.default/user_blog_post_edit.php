...
$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"PATH_TO_POST_EDIT" => ($bMicro) ? $arResult["PATH_TO_USER_MICROBLOG_POST_EDIT"] : $arResult["PATH_TO_USER_BLOG_POST_EDIT"],
...
$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"PATH_TO_BLOG"				=> ($bMicro) ? $arResult["PATH_TO_USER_MICROBLOG"] : $arResult["PATH_TO_USER_BLOG"],
		"PATH_TO_POST"				=> ($bMicro) ? $arResult["PATH_TO_USER_MICROBLOG_POST"] : $arResult["PATH_TO_USER_BLOG_POST"],
		"PATH_TO_POST_EDIT"			=> ($bMicro) ? $arResult["PATH_TO_USER_MICROBLOG_POST_EDIT"] : $arResult["PATH_TO_USER_BLOG_POST_EDIT"],
		"PATH_TO_USER"				=> $arResult["PATH_TO_USER"],
		"PATH_TO_DRAFT"				=> $arResult["PATH_TO_USER_BLOG_DRAFT"], 
