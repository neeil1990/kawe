...
if(CModule::IncludeModule("blog"))
{
	...
	$arComponentParameters["PARAMETERS"]["PATH_TO_GROUP_MICROBLOG"] = Array(
		"NAME" => GetMessage("SONET_PATH_TO_GROUP_MICROBLOG"),
		"TYPE" => "STRING",
		"MULTIPLE" => "N",
		"DEFAULT" => "/workgroups/group/#group_id#/microblog/",
		"COLS" => 25,
		"PARENT" => "URL_TEMPLATES",
	);
