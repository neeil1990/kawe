...
$MESS["CC_BLS_CHAIN_TITLE"] = "Управление разделами";
$MESS["CC_BLS_SECTION_ACTION_MENU_RENAME"] = "Переименовать";
$MESS["CC_BLS_NEW_SECTION_NAME_PROMPT"] = "Введите новое название раздела";
$MESS["CC_BLS_SECTION_ACTION_MENU_DELETE"] = "Удалить";
$MESS["CC_BLS_SECTION_DELETE_PROPMT"] = "Будут удалены все подразделы вместе с элементами. Вы уверены, что хотите удалить раздел?";
?>