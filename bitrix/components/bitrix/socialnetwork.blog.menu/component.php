	...
	if(!empty($arGroup))
	{
		if($bGroupMode && CSocNetFeatures::IsActiveFeature(SONET_ENTITY_GROUP, $arParams["SOCNET_GROUP_ID"], "blog"))
		{
			...
			if ($arParams["SET_TITLE"] != "N")
				$APPLICATION->SetTitle($arGroup["NAME"].": ".$strFeatureTitle, CComponentEngine::MakePathFromTemplate($arParams["PATH_TO_GROUP_BLOG"], array("blog" => $arResult["BLOG"]["URL"], "group_id" => $arParams["SOCNET_GROUP_ID"])));
		}
	}
}
