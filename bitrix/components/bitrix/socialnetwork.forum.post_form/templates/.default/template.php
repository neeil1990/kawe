			...
			(
				...
				(
					...
					array(
						...
						"arrFILTER_socialnetwork" => array($arParams["SOCNET_GROUP_ID"])
					) 
					: 
					array(
...
?>
		...
		<div class="forum-reply-field forum-reply-field-text">
			<textarea name="POST_MESSAGE" class="post_message" cols="55" rows="14" tabindex="<?=$tabIndex++;?>"><?=$arResult["DATA"]["POST_MESSAGE"];?></textarea>
		</div>
<?
/* EDIT PANEL */
