...
$MESS["CP_CPV_TPL_PROP_EMPTY"] = "не вибрано";
$MESS["CP_CPV_TPL_TEMPLATE_THEME"] = "Колірна тема";
$MESS["CP_CPV_TPL_CUSTOM_FILTER"] = "Фільтр товарів";
$MESS["CP_CPV_TPL_SETTINGS_INVALID_CONDITION"] = "Умову задано невірно";
...
$MESS["CP_CPV_TPL_ENLARGE_PROP"] = "Виділяти по обраній властивості";
$MESS["CP_CPV_TPL_ADD_PICT_PROP"] = "Додаткова картинка основного товару";
$MESS["CP_CPV_TPL_LABEL_PROP"] = "Властивості міток товару";
$MESS["CP_CPV_TPL_LABEL_PROP_MOBILE"] = "Властивості міток товару, що відображаються на мобільних пристроях";
...
$MESS["CP_CPV_TPL_PRODUCT_SUBSCRIPTION"] = "Дозволити сповіщення для відсутніх товарів";
...
$MESS["CP_CPV_TPL_SHOW_MAX_QUANTITY_N"] = "не показувати";
...
$MESS["CP_CPV_TPL_LAZY_LOAD"] = "Показати кнопку ледачого завантаження Lazy Load";
$MESS["CP_CPV_TPL_LOAD_ON_SCROLL"] = "Завантажувати товари при прокрутці до кінця";
$MESS["ADD_TO_BASKET_ACTION_BUY"] = "покупки";
$MESS["ADD_TO_BASKET_ACTION_ADD"] = "додати в кошик";
...
$MESS["OFFER_TREE_PROPS_TIP"] = "Властивості, за значеннями яких групуватимуться торгові пропозиції";
$MESS["PRODUCT_SUBSCRIPTION_TIP"] = "Дозволити сповіщати клієнта, що товар, який цікавить його став доступний для покупки";
...
$MESS["SHOW_CLOSE_POPUP_TIP"] = "Якщо опція відмічена, у спливаючих вікнах буде показана кнопка \"Продовжити покупки\"";
...
$MESS["CP_CPV_TPL_SETTINGS_VARIANT"] = "Варіант";
...
$MESS["CP_CPV_TPL_USE_ENHANCED_ECOMMERCE"] = "Надсилати дані електронної торгівлі в Google і Яндекс";
