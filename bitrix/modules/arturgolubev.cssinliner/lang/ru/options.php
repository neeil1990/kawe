<?
$MESS["ARTURGOLUBEV_CSSINLINER_SYSTEM_TITLE"] = "Системные настройки";
...
$MESS["ARTURGOLUBEV_CSSINLINER_CLEAR_CACHE"] = 'Настройки модуля изменены. Очистите <a target="_blank" href="/bitrix/admin/cache.php?lang=ru">Все страницы HTML кеша</a> и закройте это уведомление';
$MESS["ARTURGOLUBEV_CSSINLINER_NOTE_MAIN_JS"] = "Для максимальной эффективности необходимо установить параметр <b>\"Переместить весь Javascript в конец страницы\"</b> <a href=\"/bitrix/admin/settings.php?lang=ru&mid=main\" target=\"_blank\">в настройках главного модуля</a> ";
$MESS["ARTURGOLUBEV_CSSINLINER_MAIN_NOTE"] = "<b>Внимание:</b> Для удобства и безопасности замена в режиме администратора не производится";
$MESS["ARTURGOLUBEV_CSSINLINER_DEMO_IS_EXPIRED"] = "Демо период-модуля закончился. Полную версию решения вы можете приобрести в <a href=\"http://marketplace.1c-bitrix.ru/solutions/arturgolubev.cssinliner/\" target=\"_blank\">Marketplace 1c-Bitrix</a>";
