...
Я стараюсь создавать решения максимально функциональными, качественными и, что называется, "User friendly".<br>
<b>Ваша финансовая поддержка и отзывы крайне важны. Спасибо вам!</b> <br>';
$MESS["ISAEV_YANDEX"] = 'Яндекс.Деньги';
$MESS["ISAEV_OTHER_HELP"] = 'Другие способы поддержки';
$MESS["ISAEV_OTHER_HELP_MARKET"] = 'Написать отзыв или предложение на "Маректплейс"';
$MESS["ISAEV_OTHER_HELP_THANKS"] = 'Написать "спасибо" или предложение';
$MESS["ISAEV_OTHER_HELP_VK"] = 'ВКонтакте';
$MESS["ISAEV_OTHER_HELP_TG"] = 'Telegram';
