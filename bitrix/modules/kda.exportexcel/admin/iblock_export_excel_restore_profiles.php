...
<form action="" method="post" enctype="multipart/form-data" name="restore_profiles" id="restore_profiles">
	...
	<table width="100%">
		...
		<col width="60%">
		<tr>
			<td class="adm-detail-content-cell-l"><?echo GetMessage("KDA_IE_RESTORE_FILE");?>:</td>
		...
		<tr>
			<td class="adm-detail-content-cell-l"><?echo GetMessage("KDA_IE_RESTORE_TYPE");?>:</td>
			<td class="adm-detail-content-cell-r">
				<label><input type="radio" name="PARAMS[RESTORE_TYPE]" value="ADD" checked> <?echo GetMessage("KDA_IE_RESTORE_TYPE_ADD");?></label><br>
				<label><input type="radio" name="PARAMS[RESTORE_TYPE]" value="REPLACE"> <?echo GetMessage("KDA_IE_RESTORE_TYPE_REPLACE");?></label>
			</td>
		</tr>
	</table>
</form>
