...
include_once(dirname(__FILE__).'/BarcodeGeneratorPNG.php');
include_once(dirname(__FILE__).'/BarcodeException.php');

use Barcode\Exceptions\BarcodeException;
use Barcode\Exceptions\InvalidCharacterException;
use Barcode\Exceptions\InvalidCheckDigitException;
use Barcode\Exceptions\InvalidFormatException;
use Barcode\Exceptions\InvalidLengthException;
use Barcode\Exceptions\UnknownTypeException;
