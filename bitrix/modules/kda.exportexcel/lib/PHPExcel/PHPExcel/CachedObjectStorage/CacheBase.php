...
/**
 * KDAPHPExcel_CachedObjectStorage_CacheBase
 *
 * @category   KDAPHPExcel
 * @package    KDAPHPExcel_CachedObjectStorage
 * @copyright  Copyright (c) 2006 - 2013 KDAPHPExcel (http://www.codeplex.com/KDAPHPExcel)
 */
abstract class KDAPHPExcel_CachedObjectStorage_CacheBase {
	...
	public function __construct(KDAPHPExcel_Worksheet $parent) {
		...
		//	This is maintained within the cache controller to facilitate re-attaching it to KDAPHPExcel_Cell objects when
