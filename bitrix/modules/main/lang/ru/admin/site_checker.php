...
Для корректной работы функции необходимо <a href=\"https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=71&LESSON_ID=7655&LESSON_PATH=6415.6420.3698.7655\" target=_blank>настроить DNS для домена портала</a> и открыть доступ к порталу снаружи.";
...
$MESS["ERR_DNS"] = "Вы используете Битрикс веб-окружение старой версии, установите актуальную версию чтобы не было проблем с настройкой сервера.";
...
$MESS["SC_HELP_CHECK_REST"] = "Модуль rest должен быть установлен для интеграции с внешними приложенями и работы ряда приложений из Маркетплейс. Вы можете интегрировать свои приложения в Битрикс24 на основе <a href=\"https://dev.1c-bitrix.ru/learning/course/?COURSE_ID=43&LESSON_ID=3568\" target=\"_blank\">документации для разработчиков</a>.";
