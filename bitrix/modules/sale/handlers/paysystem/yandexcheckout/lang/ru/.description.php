...
$MESS["SALE_HPS_YANDEX_CHECKOUT_SHOP_ID"] = "Идентификатор магазина в ЦПП (ShopID)";
$MESS["SALE_HPS_YANDEX_CHECKOUT_SHOP_ID_DESC"] = "Код магазина, который получен от Яндекс";
$MESS["SALE_HPS_YANDEX_CHECKOUT_SECRET_KEY"] = "Секретный ключ";
$MESS["SALE_HPS_YANDEX_CHECKOUT_SECRET_KEY_DESC"] = "Секретный ключ, сгенерированный в личном кабинете Яндекс.Кассы";
