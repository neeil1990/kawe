...
$MESS["SALE_PROVIDER_RESERVE_BASKET_ITEM_QUANTITY_WRONG_RESIDUE"] = "Неверный количественный остаток резервируемого товара";
$MESS["SALE_PROVIDER_STORE_DATA_BARCODE_NOT_FOUND"] = "Штрих-код для товара \"#PRODUCT_NAME#\" не найден";
$MESS["SALE_PROVIDER_SHIPMENT_QUANTITY_NOT_ENOUGH"] = "Количество отгружаемого товара \"#PRODUCT_NAME#\" в корзине больше чем есть в каталоге";
...
$MESS["SALE_PROVIDER_WRONG_BASKET_ITEM"] = "Некорректный объект корзины";
$MESS["SALE_PROVIDER_BASKET_ITEM_NOT_FOUND"] = "Отсутствует связанная с элементом отгрузки ##SHIPMENT_ID# позиция в корзине ##BASKET_ITEM_ID#.";
