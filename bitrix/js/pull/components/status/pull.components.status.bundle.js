(function (exports) {
	...
	BX.Vue.component('bx-pull-status', {
	  ...
	  methods: {
	    subscribe: function subscribe(pullClient) {
	      var _this2 = this;
	    ...
	    statusChange: function statusChange(status) {
	      ...
	      var validStatus = [BX.PullClient.PullStatus.Online, BX.PullClient.PullStatus.Offline, BX.PullClient.PullStatus.Connecting];
...
//# sourceMappingURL=pull.components.status.bundle.js.map
