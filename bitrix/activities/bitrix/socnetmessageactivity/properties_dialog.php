...
<tr>
	...
	<td width="60%">
		...
		{
			?>
			<input type="text" name="message_user_from" id="id_message_user_from" value="<?= htmlspecialchars($arCurrentValues["message_user_from"]) ?>" size="50">
...
<tr>
	...
	<td width="60%">
		<input type="text" name="message_user_to" id="id_message_user_to" value="<?= htmlspecialchars($arCurrentValues["message_user_to"]) ?>" size="50">
...
<tr>
	...
	<td width="60%">
		<textarea name="message_text" id="id_message_text" rows="7" cols="40"><?= htmlspecialchars($arCurrentValues["message_text"]) ?></textarea>
