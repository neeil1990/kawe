...
StateMachineWorkflowActivity = function()
{
	...
	ob.DrawLines = function ()
	{
		...
		for(i=0; i<ar.length; i++)
		{
			...
			d3.style.top = to['top'] + (to['bottom'] - to['top'])/2+ 'px';

			d3.style.width = W/2 - C+ 'px';
