...
<tr>
	<td align="right" width="40%"><span style="color:#FF0000;">*</span> <?= GetMessage("BPTA1A_TASK_TYPE") ?>:</td>
	<td width="60%">
...
<tr>
	<td align="right" width="40%"><span style="color:#FF0000;">*</span> <?= GetMessage("BPTA1A_TASKOWNERID") ?>:</td>
	<td width="60%">
		<select name="task_owner_id" id="id_task_owner_id">
			<?
...
if (count($arForums) > 0)
{
	?>
	<tr>
		<td align="right" width="40%"><span style="color:#FF0000;">*</span> <?= GetMessage("BPTA1A_TASKFORUM") ?>:</td>
		<td width="60%">
