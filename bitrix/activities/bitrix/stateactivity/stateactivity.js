...
StateActivity = function()
{
	...
	ob.Draw = function (divC)
	{
		...
		var sp = c.appendChild(document.createElement('SPAN'));
	...
	ob.ShowAddMenu = function (e)
	{
		...
		ob.menuItems = Array();
		ob.menuItems.push({'ID': '2', 'TEXT':	'<div style="text-align: left;">'+BPMESS['STATEACT_MENU_COMMAND']+'</div>', 'ONCLICK': "__StateActivityAdd('command', '"+ob.Name+"')"});
		ob.menuItems.push({'ID': '3', 'TEXT':	'<div style="text-align: left;">'+BPMESS['STATEACT_MENU_DELAY']+'</div>', 'ONCLICK': "__StateActivityAdd('delay', '"+ob.Name+"')"});
		if(!bStart)
			ob.menuItems.push({'ID': '1', 'TEXT':	'<div style="text-align: left;">'+BPMESS['STATEACT_MENU_INIT']+'</div>', 'ONCLICK': "__StateActivityAdd('init', '"+ob.Name+"')"});
		if(!bFinish)
			ob.menuItems.push({'ID': '5', 'TEXT':	'<div style="text-align: left;">'+BPMESS['STATEACT_MENU_FIN']+'</div>', 'ONCLICK': "__StateActivityAdd('finish', '"+ob.Name+"')"});
