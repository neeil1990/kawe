...
<?$ElementID = $APPLICATION->IncludeComponent(
	...
	<a href="<?=$arResult["FOLDER"].$arResult["URL_TEMPLATES"]["news"]?>" class="news__all">Все новости</a>



	<?$APPLICATION->IncludeComponent("bitrix:news.line", "news.list.intersting", Array(
